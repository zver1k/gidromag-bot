...
INVOICE_PATTERN = ^[а-яА-ЯёЁa-zA-Z0-9]{3,50}$'
...
ERROR_MESSAGES = {
    ...
    "invoice_limit_reached": "❌ Достигнут лимит фото для накладной '{invoice}'\n\nМаксимум: {max_photos} фото\nТекущее количество: {current_photos}\n\nИспользуйте /reset для сброса и начала новой накладной.",
...
INFO_MESSAGES = {
    "waiting_photo": "📸 Я жду фото, пришлите изображение.",
    ...
    "approaching_limit": "⚠️ Внимание! Приближается лимит фото для накладной '{invoice}'\nОсталось: {remaining} фото",
}
...
3. Отправьте фото оборудования
4. Фото автоматически сохранится на Яндекс.Диск
